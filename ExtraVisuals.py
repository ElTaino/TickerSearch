...
import pandas as pd  # <-- ADDED FOR RE-INDEX DATA CLEANUP
...
if ticker_symbol:
    try:
        ...
        if stock_data.empty:
            ...
            # --- CRITICAL FIX: FLATTEN MULTIINDEX COLUMNS DROPPING THE TICKER LAYER ---
            ...
            # 4. Color Coding for Volume Bars (Green for up days, Red for down days)
            ...
            fig.update_layout(
                ...
                yaxis3_range=[10, 90],  # <-- FIXED SYNTAX ERRORS HERE
                height=800, 
                hovermode="x unified", 
